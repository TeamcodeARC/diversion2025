    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="space-y-6">
          <DashboardCard title="Fault Detection" maxHeight="max-h-[300px]">
            <FaultDetectionSystem zones={mockZones} />
          </DashboardCard>
          <DashboardCard title="Device Simulator" maxHeight="max-h-[300px]">
            <DeviceSimulator />
          </DashboardCard>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <DashboardCard title="Recent Alerts" maxHeight="max-h-[300px]">
